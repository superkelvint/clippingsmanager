...
import { createEditingController } from './editing.js';
        ...
        const editingController = createEditingController({
            ...
            els,
            insertFragmentAtCursor: (...args) => insertFragmentAtCursor(...args),
            isTextEditorTarget: (...args) => isTextEditorTarget(...args),
            isSubsectionOrSectionTarget: (...args) => isSubsectionOrSectionTarget(...args),
            sanitizeHtmlToFragment: (...args) => sanitizeHtmlToFragment(...args),
            insertPlainText: (...args) => insertPlainText(...args),
            triggerContentUpdate: (...args) => triggerContentUpdate(...args),
            saveNow: (...args) => saveNow(...args),
            refreshHighlightPopup: (...args) => refreshHighlightPopup(...args),
            hideHighlightPopup: (...args) => hideHighlightPopup(...args),
            showHighlightPopupForMark: (...args) => showHighlightPopupForMark(...args),
        });
        const { bindEditingModeListeners, unbindEditingModeListeners } = editingController;
